...
@section('content')
    @if(isset($error))
        <div class="alert alert-danger alert-dismissible fade show justify-content-center">
            ...
            <strong>{{ __('Error!') }}</strong> {{ $error }}</div>
        <div class="card shadow-sm">
            <div class="card-body bg-light justify-content-center">{{ __('Make your short link here for free') }}
                <div class="row">
    ...
    @else
        <div class="card shadow-sm">
            <div class="card-body bg-light">
                <form method="POST" action="{{ action('URLShortenerController@doShort')  }}"
                    ...
                    <div class="form-group"><label for="urlform">{{ __('URL') }}</label><input id="urlform" type="url"
                                                                                               ...
                                                                                               required autofocus>
                        <small id="urlHelp"
                               class="form-text text-muted">{{ __('Enter the link that you want to short.') }}</small>
                    </div>
                    <div class="form-group"><label for="customurlform">{{ __('Custom URL') }}</label>
